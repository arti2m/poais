...
class Poruchenie(models.Model):
    ...
    otprzapr = models.TextField(null=True,blank=True, verbose_name='информация по направлению запросов')
    polzapr = models.TextField(null=True,blank=True, verbose_name='Информация по получению ответа на запрос')
    kratkopisisppor = models.TextField(null=True,blank=True, verbose_name='краткое описание исполнения поручения')
    anal = models.TextField(null=True,blank=True, verbose_name='аналитика ("архивные" комментарии)')
